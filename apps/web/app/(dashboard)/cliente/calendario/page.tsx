    ...
    <div className="flex flex-col flex-1">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Vista {viewMode === "month" ? "mensual" : viewMode === "week" ? "semanal" : "diaria"} de tus publicaciones</p>
        </div>
        {hasReviewPosts && (
          <Badge className="bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400">
            Tienes publicaciones por aprobar
          </Badge>
        )}
      </div>
