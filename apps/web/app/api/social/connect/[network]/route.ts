...
> = {
  facebook: {
    ...
    scopes:
      "pages_manage_posts,pages_read_engagement,instagram_content_publish,instagram_basic,pages_show_list,pages_manage_metadata,instagram_business_manage_insights",
