...
const plans = [
  {
    ...
    price: "$29",
    period: "/mes",
    description: "Para freelancers y equipos pequenos que estan empezando.",
    features: [
      "Hasta 5 cuentas sociales",
      "Calendario editorial",
      "Publicacion directa",
      "1 usuario",
      "Aprobacion de clientes",
      "Soporte por email",
    ],
    cta: "Empezar gratis",
  ...
  },
  {
    ...
    features: [
      "Hasta 25 cuentas sociales",
      "Todo en Starter +",
      "5 usuarios",
      "Asistente de IA",
      "Metricas y reportes",
      "Kit de marca por cliente",
      "Banco de ideas",
      "Soporte prioritario",
    ],
    cta: "Empezar gratis",
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    description: "Para agencias grandes con necesidades avanzadas.",
    features: [
    ...
    href: "mailto:ventas@isysocial.com?subject=Isysocial Enterprise",
    highlighted: false,
  },
];
            ...
            <ScrollAnimation key={plan.name} delay={index * 0.1}>
              <div
                className={cn(
                  ...
                  plan.highlighted
                    ? "bg-card shadow-lg scale-[1.02] md:scale-105 ring-2 ring-primary/20"
